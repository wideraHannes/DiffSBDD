...
def compute_smiles(positions, one_hot, mask):
    ...
    for i, (pos, atom_type) in pbar:
        mol = build_molecule(
            pos, atom_type, dataset_info, use_openbabel=False
        )  # TODO i switched from openbabel
...
if __name__ == "__main__":
    ...
    # DEBUG MODE: Limit dataset size for faster debugging
    # Original full dataset sizes will be much larger
    print(
